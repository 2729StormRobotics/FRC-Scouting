...
public class DatabaseAccess {
	...
	private String fileName = "Aerial_Assist";	
	...
	public static void main( String args[] ){
		...
		Random r = new Random();
		db.updateDatabase("2729,2,1,1,0,0,2,1,0,1,6,'0,5,3,4,3,2',9,4,4,'0,3,2,3,1,0',3,2,4,'0,1,0,2,0,2','0,0,1,0,0,0','0,0,1,0,0,1',3,1,1,'-1,1,1,0,1'");
		//display results
		ArrayList<AerialAssit> results = db.getDatabase();	
		for (int i = 0; i < results.size(); i++){
			System.out.println(results.get(i).getTeamNum());
			System.out.println(results.get(i).getMatchNum());
			System.out.println(results.get(i).getIsRed());
			System.out.println(results.get(i).getTopAuto());
			System.out.println(results.get(i).getTopMissesAuto());
			System.out.println("");
		}
	}
	...
	public ArrayList<AerialAssit> getDatabase() {
		//returns a ResultSet of all results
	    ArrayList<AerialAssit> results = new ArrayList<AerialAssit>();
	    ...
	    try {
		    ...
		    while ( rs.next() ) {
		    	...
		    	AerialAssit aa = new AerialAssit();
